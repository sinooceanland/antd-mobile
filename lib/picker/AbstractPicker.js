    ...
    function AbstractPicker() {
        ...
        _this.getPickerCol = function () {
            ...
            return data.map(function (col, index) {
                let itemStyle = [_this$props.itemStyle, _this$props['itemStyle' + index]];
                let style = {flex: 1};
                if(_this$props.style || _this$props['style' + index])
                    style = [_this$props.style, _this$props['style' + index]];
                return _react2['default'].createElement(
                    _Picker2['default'],
                    { key: index, prefixCls: pickerPrefixCls, style, itemStyle: itemStyle, indicatorStyle: indicatorStyle },
